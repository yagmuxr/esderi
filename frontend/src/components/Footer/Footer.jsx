                ...
                <div className="footer-widgets">
                    <div className="brand-info">
                        <div className="footer-logo">
                             <a href="index.html" className="logo">EsDeri Leather</a>
                        </div>
                        <div className="footer-desc">
                            <p> An indie leather brand, starting its journey in Turkey, now continues in the Netherlands.</p>
                        </div>
            ...
            <div className="container">
                <div className="footer-copyright">
                    <div className="site-copyright">
                        <p>
                            Copyright 2024 © E-Commerce Theme. All right reserved. Powered by Yağmur Yalçın.
                        </p>
                    </div>
                    <a href="#">
